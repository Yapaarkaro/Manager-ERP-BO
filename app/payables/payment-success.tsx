...
import { setNavData, consumeNavData } from '@/utils/navStore';
...
export default function PaymentSuccessScreen() {
  ...
  const payment = consumeNavData('payablePaymentResult') || (params.paymentData ? JSON.parse(params.paymentData as string) : {});
  ...
  const handleViewSupplierAccount = () => {
    setNavData('payableSupplierData', {
